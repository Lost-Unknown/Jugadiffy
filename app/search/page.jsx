    ...
    <section>
      ...
      <div className="md:hidden flex flex-col gap-2 justify-center items-center">
        ...
        <div className="w-full border rounded-md border-zinc-500 text-zinc-300 p-2">
          <p onClick={() => settoggleDropdownFilter((prev) => !prev)}>Filter</p>
          {toogleDropdownFilter && (
            <div>
              <p
                onClick={() => settoggleDropdownPrice((prev) => !prev)}
                className="w-full text-zinc-300 p-2 text-xl ring-2 ring-zinc-950 rounded-md bg-zinc-700"
              >
                Price
              </p>
              {toogleDropdownPrice && (
              ...
              <p
                ...
                className="w-full text-zinc-300 p-2 ring-2 ring-zinc-950 rounded-md text-xl bg-zinc-700"
              >
                Colour
              </p>
