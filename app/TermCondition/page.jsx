    ...
    <section className="flex flex-col gap-4 items-start md:w-10/12 w-full md:mx-auto mx-0">
      ...
      <div className="md:text-xl text-lg text-justify  text-zinc-800">
        <div class="rte">
          ...
          <span>Jugaadify</span>. Throughout the site, the terms “we”, “us” and
          “our” refer to <span>Jugaadify</span> Final. <span>Jugaadify</span> offers
          this website, including all information, tools and services available
          from this site to you, the user, conditioned upon your acceptance of
          all terms, conditions, policies and notices stated here. <br /> <br />{" "}
          ...
          according to our Return Policy. <br /> We have made every effort to
          ...
          needed. <br /> <br /> For more detail, please review our Returns
          Policy. <br /> <br /> <strong>SECTION 7 - OPTIONAL TOOLS</strong>{" "}
          <br /> We may provide you with access to third-party tools over which
          we neither monitor nor have any control nor input. <br /> You
          ...
          third-party tools. <br /> Any use by you of optional tools offered
          ...
          purpose, durability, title, and non-infringement. <br /> In no case
          shall <span>Jugaadify</span> Final, our directors, officers, employees,
          ...
          indemnify, defend and hold harmless <span>Jugaadify</span> Final and our
